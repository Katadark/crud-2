...
def main():
    while True:
        ...
        print("4. Cadastrar um motocicleta")
        print("5. Listar todos os  motocicletas")
        print("6. Excluir  um motocicleta")
        print("7. Editar um cliente")
        print("8. Editar um motocicleta")
        print("0. Sair")
